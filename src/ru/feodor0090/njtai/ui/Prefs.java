...
final class Prefs extends Form implements ItemCommandListener, CommandListener {
	...
	private final StringItem ramWarn = new StringItem("Warning", "Enabling preloading/caching may cause crash on low memory devices.");
	
	private final ChoiceGroup cache = new ChoiceGroup("Keep images in RAM", 4, yn, null);
	private final ChoiceGroup preload = new ChoiceGroup("Preload all pages", 4, yn, null);
